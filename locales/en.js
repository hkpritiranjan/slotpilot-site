(function () {
  ...
  window.SP_LOCALES.en = {
    ...
    'hiw.tip4.text':    'SMS delivery in India can be unreliable. The WhatsApp Business API integration will replace SMS entirely &mdash; same YES/NO reply flow, but through WhatsApp where Indian patients actually respond.',
