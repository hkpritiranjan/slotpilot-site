(function () {
  ...
  window.SP_LOCALES.en = {
    ...
    'how.step1.desc':    'Share your <em>/book/your-clinic</em> booking link or <em>/join/your-clinic</em> waitlist link. Patients self-book open slots or join the waitlist in 90 seconds. No app required.',
    ...
    'feat.7.desc':   'Live via Twilio WhatsApp. Patients reply YES on WhatsApp &mdash; slot auto-books. No staff needed.',
    'feat.7.live':   '&#10003;&nbsp;Live',
    'feat.10.title': 'Visual calendar',
    'feat.10.desc':  'Week and month view of all your slots. Drag directly on the grid to create a slot &mdash; no form to fill.',
    'feat.10.live':  '&#10003;&nbsp;Live',
    'feat.11.title': 'Patient booking page',
    'feat.11.desc':  'A shareable <em>/book/your-clinic</em> link patients open to self-book available slots. Date tabs, one-tap booking, WhatsApp confirmation. No account needed.',
    'feat.11.live':  '&#10003;&nbsp;Live',
    ...
    'price.f9':      'Recovery stats &amp; fill-rate dashboard',
    'price.f10':     'Patient-facing booking page (/book/slug)',
    ...
    'hiw.1.desc':     'Takes 10 minutes. Create a free account, enter your clinic name, configure your appointment types (e.g. Initial Assessment, Follow-up, Dry Needling), and you&rsquo;re given a public link your patients can use to join your waitlist.',
    ...
    'hiw.1.card2p':   'Share the link anywhere: WhatsApp, your email footer, a printed card at reception, your Practo profile bio, Instagram bio. Patients open it on their phone, enter name + mobile number + which appointment type they need, and they&rsquo;re in. No app, no account, 90 seconds.',

    'hiw.2.eyebrow':  'Daily workflow',
    'hiw.2.title':    'A patient cancels (or doesn&rsquo;t show up)',
    'hiw.2.desc':     'When a booked patient cancels by call or WhatsApp, your receptionist opens SlotPilot and clicks <strong>Cancel</strong> on that slot. If a patient simply didn&rsquo;t show up, they click <strong>No-show</strong>. That&rsquo;s the only action your staff takes.',

    'hiw.3.eyebrow':    'Automatic',
    'hiw.3.title':      'SlotPilot texts the next patient on the waitlist',
    'hiw.3.desc':       'The system scans the waitlist for the next patient who needs an <em>Initial Assessment</em> (matching the cancelled slot&rsquo;s type), ordered by priority then join date. It sends them an SMS instantly.',
    ...
    'hiw.4.desc1':    'If the patient replies YES within 15 minutes, the slot is booked under their name, a confirmation SMS is sent, and the slot card in your dashboard updates immediately. Your receptionist sees this happen &mdash; they don&rsquo;t do anything.',
    'hiw.4.desc2':    'If the patient replies NO, or doesn&rsquo;t respond in 15 minutes, the cascade moves on automatically to the next person on the list.',
    ...
    'hiw.5.desc':    'Every booked patient (including waitlist fills and original bookings) automatically receives reminder SMS messages. This reduces no-show rates by 30&ndash;40%.',
    ...
    'hiw.tips.sub':     'SlotPilot doesn&rsquo;t replace your booking system. It plugs into the gap: the slot that just opened that your booking system can&rsquo;t fill automatically.',
    'hiw.tip1.label':   '&#128203; Clinic using Practo',
    'hiw.tip1.text':    'New patients book via Practo as normal. Your existing patients who&rsquo;ve asked to be notified of openings join your SlotPilot waitlist. When a Practo booking cancels, you mark it in SlotPilot. It fills the gap from your local waitlist &mdash; Practo never knows.',
    'hiw.tip2.label':   '&#128203; Clinic without Practo',
    'hiw.tip2.text':    'Most of your patients come by word-of-mouth or walk-in. You add their upcoming bookings to SlotPilot manually. Patients who call asking about openings are told to join the waitlist via the link. When anything cancels, SlotPilot handles the recovery.',
    'hiw.tip3.label':   '&#8679; Priority queue use case',
    'hiw.tip3.text':    'A post-surgery patient needs physiotherapy within the week but your calendar is full. Add them to the waitlist and mark them as <strong>high priority</strong>. The next time any slot cancels, they&rsquo;re the first person texted.',
    'hiw.tip4.label':   '&#128172; WhatsApp (live)',
    'hiw.tip4.text':    'SMS delivery in India can be unreliable. SlotPilot uses the Twilio WhatsApp Business API &mdash; same YES/NO reply flow patients already know, but through WhatsApp where Indian patients actually respond. Choose WhatsApp or SMS per patient.',
